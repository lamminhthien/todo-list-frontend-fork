...
export const JoinerBgColos = ['bg-red-500', 'bg-orange-500'];
...
export const PriorityIcons = {lowest: 'ico-chevrons-down', low: 'ico-chevron-down', medium: 'ico-equal', high: 'ico-chevron-up', highest: 'ico-chevrons-up'};
