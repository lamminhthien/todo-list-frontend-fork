...
const getAllTodo = () => HttpRequest.get<List[]>(`${API_ENDPOINTS.TODO}/query/all`);
...
export default {getTodos, getTodo, createTodo, updateTodo, deleteTodo, getLastTodo, getAllTodo};
